...
| [目次](./目次.md) | 全33章の完全な目次と学習パス |
| [第1章：エージェントの本質](./Part1-エージェント基礎/第01章：エージェントの本質.md) | 読み始める |
| [Shannon OSS](https://github.com/Kocoro-lab/Shannon) | 参考実装コード |
| [ShanClaw OSS](https://github.com/Kocoro-lab/ShanClaw) | ローカル Agent Harness 参考実装（→ [第33章](Part9-最先端実践/第33章：Building-on-the-Harness-ShanClaw.md)） |
